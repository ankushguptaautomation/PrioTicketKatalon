...
WebUI.click(findTestObject('PrioTicket Catalog Objects/Catalog Active Inactive Objects/direct_inactive_button'))
...
List<WebElement> pagination = WebUI.findWebElements(findTestObject('PrioTicket Catalog Objects/Catalog Active Inactive Objects/direct_catalog_click'), 
    2)
