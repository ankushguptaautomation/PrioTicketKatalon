...
WebUI.callTestCase(findTestCase('PrioTicket Catalog/Catalog Filters count Active Inactive All/catalog_selection'), null)
...
WebUI.click(findTestObject('PrioTicket Catalog Objects/Catalog Active Inactive Objects/direct_active_button'))
...
List<WebElement> pagination = WebUI.findWebElements(findTestObject('PrioTicket Catalog Objects/Catalog Active Inactive Objects/direct_catalog_click'),2)
